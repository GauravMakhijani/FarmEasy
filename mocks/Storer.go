...
// Book provides a mock function with given fields: _a0, _a1
func (_m *Storer) Book(_a0 context.Context, _a1 domain.NewBookingRequest) (domain.NewBookingResponse, error) {
	ret := _m.Called(_a0, _a1)
